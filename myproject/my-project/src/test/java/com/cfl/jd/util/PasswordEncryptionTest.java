...
public class PasswordEncryptionTest {
    public static void main(String[] args) throws InvalidKeySpecException, NoSuchAlgorithmException {
        String str1 = PasswordEncryptionUtil.generateSalt();
        str1 = "3d06085176e1fad41ea8046dea17586b";
        System.out.println("str1 = " + str1);
        System.out.println(PasswordEncryptionUtil.getEncryptedPassword("123456", str1));
        ...
        .equals(PasswordEncryptionUtil.getEncryptedPassword("123456", str1)));
    }
}
